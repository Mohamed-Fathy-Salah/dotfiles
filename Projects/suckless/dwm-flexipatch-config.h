...
static char normbordercolor[]            = BG_COLOR;
static char normfloatcolor[]             = FG_COLOR;

static char selfgcolor[]                 = FG_COLOR;
static char selbgcolor[]                 = BG_COLOR;
static char selbordercolor[]             = FG_COLOR;
static char selfloatcolor[]              = FG_COLOR;

static char titlenormfgcolor[]           = "#ebdbb2";
static char titlenormbgcolor[]           = BG_COLOR;
static char titlenormbordercolor[]       = BG_COLOR;
static char titlenormfloatcolor[]        = FG_COLOR;

static char titleselfgcolor[]            = FG_COLOR;
static char titleselbgcolor[]            = BG_COLOR;
static char titleselbordercolor[]        = FG_COLOR;
static char titleselfloatcolor[]         = FG_COLOR;

static char tagsnormfgcolor[]            = "#ebdbb2";
static char tagsnormbgcolor[]            = BG_COLOR;
static char tagsnormbordercolor[]        = BG_COLOR;
static char tagsnormfloatcolor[]         = FG_COLOR;

static char tagsselfgcolor[]             = FG_COLOR;
static char tagsselbgcolor[]             = BG_COLOR;
static char tagsselbordercolor[]         = FG_COLOR;
static char tagsselfloatcolor[]          = FG_COLOR;

static char hidnormfgcolor[]             = FG_COLOR;
static char hidselfgcolor[]              = FG_COLOR;
static char hidnormbgcolor[]             = BG_COLOR;
static char hidselbgcolor[]              = BG_COLOR;

static char urgfgcolor[]                 = "#ebdbb2";
static char urgbgcolor[]                 = BG_COLOR;
static char urgbordercolor[]             = ORCHIS_RED;
static char urgfloatcolor[]              = ORCHIS_RED;

#if BAR_LTSYMBOL_SCHEME_PATCH
static char ltsymbolfgcolor[]            = FG_COLOR;
static char ltsymbolbgcolor[]            = BG_COLOR;
#endif // BAR_LTSYMBOL_SCHEME_PATCH

#if RENAMED_SCRATCHPADS_PATCH
static char scratchselfgcolor[]          = "#eeeeee";
static char scratchselbgcolor[]          = FG_COLOR;
static char scratchselbordercolor[]      = FG_COLOR;
static char scratchselfloatcolor[]       = FG_COLOR;

static char scratchnormfgcolor[]         = "#ebdbb2";
static char scratchnormbgcolor[]         = BG_COLOR;
static char scratchnormbordercolor[]     = BG_COLOR;
static char scratchnormfloatcolor[]      = FG_COLOR;
