...
static MouseShortcut mshortcuts[] = {
	...
	{ XK_ANY_MOD,           Button4, ttysend,        {.s = "\031"}, 0, S_PRI },
	{ XK_ANY_MOD,           Button5, ttysend,        {.s = "\005"}, 0, S_PRI },
	#else
...
static Shortcut shortcuts[] = {
	...
	{ Mod1Mask,             XK_g,           kscrollup,       {.i = 999999}, S_PRI },
	{ Mod1Mask|ShiftMask,   XK_g,           kscrolldown,     {.i = 999999}, S_PRI },
	...
	{ Mod1Mask,             XK_Escape,      keyboard_select, { 0 } },
	#endif // KEYBOARDSELECT_PATCH
	#if KEYBOARDSELECT_PATCH && REFLOW_PATCH
	{ Mod1Mask,              XK_F,           searchforward,   { 0 } },
	{ Mod1Mask,              XK_B,           searchbackward,  { 0 } },
	#endif // KEYBOARDSELECT_PATCH
	#if ISO14755_PATCH
